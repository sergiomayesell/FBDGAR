...
Teniendo instalado \textit{apache ant}, nos situaremos en la carpeta del proyecto, de tal forma que estando en el directorio  \textit{Aplicacion Java$/$} basta con ejecutar el comando \textbf{ \textdollar ant jar} y posteriormente ubicarnos dentro del directorio \textit{dist$/$} para posteriormente ejecutar la aplicación por medio del comando \textbf{java $-$jar BTras$.$jar }\\
