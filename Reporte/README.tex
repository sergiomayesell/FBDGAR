...
Los reportes están contenidos dentro de la carpeta \textit{Reportes} y son las consultas con formato de reportes.
...
Una vez que hemos generado el tar, podemos ejecutarlo libremente en entorno gráfico con un sencillo doble click en la aplicación generada, cómo se aprecia en el diagrama [\ref{arbol}].\\
...
\begin{figure}[htp]
	...
	\caption{Ejemplo de la estructura del árbol de direcciones para  ejecutar la aplicación.}
	\label{arbol}
\end{figure}
\end{centering}
