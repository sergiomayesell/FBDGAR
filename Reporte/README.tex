...
\author{Herrera Ortíz, Oscar \\ Galván Gámez, Edwin Antonio \\ Mayesell Colorado, Sergio}
...
\begin{itemize}
\item AbonoAhorroFisicas.sql\item atm.sql\item CAhorroMorales.sql\item Consultas\_no\_triviales.sql\item Correofisicas.sql\item CuentaAhorroFisicas.sql\item CuentasPersonasFisicas.sql\item CuentasPrestamoFisicas.sql\item CuentasPrestamoMorales.sql\item EmailEmpleados.sql\item emailMoral.sql\item empleado.sql\item EvalFisica.sql\item EvalMoral.sql\item fisica.sql\item moral.sql\item PagoPersonasMorales.sql\item PagosPrestamosPersonasFisicas.sql\item PagoTarjetasAhorroMorales.sql\item \textbf{public.sql}\item Qfisica.sql\item QMoral.sql\item RetiroAhorroATMFisica.sql\item RetiroATMMorales.sql\item RetiroCuentasVentanilla.sql\item RetiroPrestamoMorales.sql\item RetiroPrestamosFisicos.sql\item RetirosVentanillaFisica.sql\item Sucursal.sql\item TarjetaCreditoMoral.sql\item TarjetasAhorroFisica.sql\item TarjetasDebitoFisicas.sql\item tarjetasDebitoMoral.sql\item TelefonosFisicas.sql\item TelefonosMorales.sql\item TelEmpleado.sql
\item \textbf{Triggers.sql}\item Ventanillas\_Asignadas.sql\item ventanillas.sql
\end{itemize}
